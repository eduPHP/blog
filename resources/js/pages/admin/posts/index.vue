<template>
  <div class="flex-1 flex flex-col">
    <div class="flex justify-between">
      ...
      <router-link to="/admin/posts/create">Add</router-link>
    </div>
    <div class="flex-1">
      <div>
        <div class="flex flex-col">
          <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-4 lg:-mx-8 lg:px-8">
            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-md border-b border-gray-200">
                  ...
                  <td class="px-4 py-4 whitespace-no-wrap border-b border-gray-200">
                    <div class="flex items-center">
                      <div class="flex-shrink-0 h-10 w-10">
                        <svg class="h-10 w-10" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
